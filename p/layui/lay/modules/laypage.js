    ...
    u.prototype.view = function() {
        ...
        i = {
            ...
            page: function() {
                ...
                var width = (document.body.scrollWidth - 330) / (a.count) - 32;
                for (u - r < t - 1 && (r = u - t + 1), a.first !== !1 && r > 2 && e.push('<span class="layui-laypage-spr">&#x2026;</span>'); r <= u; r++) r === a.curr ? e.push('<span class="layui-laypage-curr" style="text-align:center;width:' + width + 'px;" ><em class="layui-laypage-em" ' + (/^#/.test(a.theme) ? 'style="background-color:' + a.theme + ';"': "") + "></em><em>" + a.types()[r-1].replace('green', 'white') + "</em></span>") : e.push('<a href="javascript:;" data-page="' + r + '" style="text-align:center;width:' + width + 'px">' + a.types()[r-1] + "</a>");
            ...
            refresh: ['<a href="javascript:;" data-page="' + a.curr + '" class="layui-laypage-refresh layui-hide">', '<i class="layui-icon layui-icon-refresh"></i>', "</a>"].join(""),
            skip: function() {
