...
% % Test code for the unsilmultaneous iteration
% % Written by Yue Qiu
% %
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
rng(1e3)
lambda = randn(n, 1) + unifrnd(1e-4, 1e3, n, 1);   % random generate the eigenvalues
lambda = [1e5; lambda(2:end)];
...
Z = randn(n, r);
[Z, ~] = qr(Z, 0);    % initial matrix with orthonormal columns
