...
In the Viterbi algorithm,  $m_{1: t+1}\left(X_{t+1}\right)=P\left(X_{t+1} \mid e_{t+1}\right) \max _{x_{t}} P\left(X_{t+1} \mid x_{t}\right) m_{1: t}\left(x_{t}\right)$ , where  $m_{1: t}\left(X_{t}\right)=\max _{x_{1: t-1}} P\left(X_{1: t} \mid e_{1: t}\right) $
...
$$ Q(s, a) \leftarrow(1-\alpha) Q(s, a)+\alpha[R\left(s, a, s^{\prime}\right)+\gamma \max _{a^{\prime}} Q\left(s^{\prime}, a^{\prime}\right)] $$
