...
title: "Question 4 - Model-Based Learning"
content: """
Assuming we are doing model-based learning on the map below, where A is the start state and D, E are two terminal states.

<p><img src="./image/hw5/3(1)(1).png"></p>

During the training process, 5 episodes are observed as below:
...
What model will be learned based on these 5 episodes? If the answer is infinite, please keep 3 decimals.

"""
choice: """
<div class="question q1 q-text" answer="{'0.5':2.5}">
    <p style="display: inline;">T(B, east, D) = </p>
    <input type="text" name="q1" placeholder="" class="layui-input" style="display: inline;">
    <p class="tick-label" style="display: inline;"></p>
</div>
<div class="question q2 q-text" answer="{'0.667':2.5}">
    <p style="display: inline;">T(B, south, C) = </p>
    <input type="text" name="q2" placeholder="" class="layui-input" style="display: inline;">
    <p class="tick-label" style="display: inline;"></p>
</div>
<div class="question q3 q-text" answer="{'0.5':2.5}">
    <p style="display: inline;">T(C, east, E) = </p>
    <input type="text" name="q3" placeholder="" class="layui-input" style="display: inline;">
    <p class="tick-label" style="display: inline;"></p>
</div>
<div class="question q4 q-text" answer="{'1':2.5}">
    <p style="display: inline;">T(C, northeast, D) = </p>
    <input type="text" name="q4" placeholder="" class="layui-input" style="display: inline;">
    <p class="tick-label" style="display: inline;"></p>
</div>
<div class="question q5 q-text" answer="{'-0.5':2.5}">
    <p style="display: inline;">R(C, northeast, D) = </p>
    <input type="text" name="q5" placeholder="" class="layui-input" style="display: inline;">
    <p class="tick-label" style="display: inline;"></p>
</div>
"""
...
<div class="question q3 q-text" answer="{'-0.613':1.7,'-0.61325':1.7}" style="display: inline; margin-right: 1em;">
...
<div class="question q5 q-text" answer="{'2.21425':1.7,'2.214':1.7}" style="display: inline; margin-right: 1em;">
    <p style="display: inline;">B</p>
    <input type="text" name="q5" placeholder="" class="layui-input" style="display: inline;">
    <p class="tick-label" style="display: inline;"></p>
</div>
...
"""
choice: """
<div class="question q1 q-text" answer="{'7.02': 5}">
    <p style="display: inline;">$Q'(3, right) = $</p>
    <input type="text" name="q1" placeholder="" class="layui-input" style="display: inline;">
    <p class="tick-label" style="display: inline;"></p>
</div>
<div class="question q2 q-text" answer="{'9.2': 5}">
