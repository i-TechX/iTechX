...
\newcommand{\hmwkDueDate}{March 13, 2022}
\newcommand{\hmwkClass}{Algorithm Design and Analysis}
\newcommand{\hmwkClassInstructor}{Professor Rui Fan}
\newcommand{\hmwkAuthorName}{Hello Kitty}
\newcommand{\hmwkAuthorID}{08171926}
