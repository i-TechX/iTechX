            ...
            render_: function(container){
                ...
                if (content == undefined) {
                    node.innerHTML = '<div style="text-align: center;">\
                        ...
                        <p style="text-align: center; font-size: 1em; line-height: 1.3em; margin-bottom: 3rem; padding: 0; text-shadow: 0 0 1rem #fefefe; font-family: Quicksand, Arial; color: #b4b4b4;">you have not logged in and have reached github\'s request rate limit. Please login to continue.</p>\
