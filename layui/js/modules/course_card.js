                        ...
                        if (data) {
                            if (data && data.content) {
                                ...
                                if (elem.hasOwnProperty("status") && elem.status == "activate"){
                                    ...
                                    cardHTML = '<div class="layui-card" style="border-radius: 10px; margin-bottom: 15px;"><div class="layui-card-body"><div class="layui-row"><div class="layui-col-md3" style="display: flex; justify-content: center;"><a href="courses?course_code='+ elem.code +'"><img class="shadow" src="'+ elem.cover +'"style="width:210px;"></a></div><div class="layui-col-md9"><div style="margin: 5px 1em;"><div style="font-family: Quicksand; font-weight: bold; text-align: left; font-size: 2em; height: 1em;"><a href="courses?course_code='+ elem.code +'">'+ elem.name +'</a></div><div class="layui-row"><div class="layui-col-md9"><p style="padding-top: 1%; text-align: left; font-family: Quicksand; font-weight: bold; font-size: 1.2em; margin-bottom: 0.2em; color:#8FBC8F;">ACTIVATE</p></div></div><div class="layui-row"><div class="layui-col-md9"><p style="padding-top: 7%; text-align: left; font-size: 1.2em; margin-bottom: 0.2em;">'+ elem.code +'</p><p style="text-align: left; font-size: 1.2em; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;">'+ semester_strings.join(', ') +'</p></div><div class="layui-col-md3" style="padding-top: 5%; text-align: center;"><a href="courses?course_code='+ elem.code +'" class="layui-btn layui-btn-lg layui-btn-violet" style="font-weight: normal;">查看课程</a></div></div></div></div></div></div></div>';
                                } else {
