                ...
                $.ajax({
                    ...
                    error: function(err) {
                        ...
                        element.innerHTML = '<div style="text-align: center;">\
                            ...
                            <p style="text-align: center; font-size: 1em; line-height: 1.3em; margin-bottom: 3rem; padding: 0; text-shadow: 0 0 1rem #fefefe; font-family: Quicksand, Arial; color: #b4b4b4;">You may have reached github\'s request rate limit. Login to continue.</p>\
                    ...
                    success: function (data) {
                        if (data) {
                            if (data && data.content) {
                                ...
                                var d = document.createElement('div');
                                elem.cover = elem.cover || 'https://ghproxy.com/https://raw.githubusercontent.com/' + options.owner + '/' + options.repo + '/file-base/courses/' + course_code + '/cover.jpg';
                                if (elem.hasOwnProperty("status") && elem.status == "activate"){
                                    d.classList.add("activate");
                                    cardHTML = '<div class="layui-card" style="border-radius: 10px; margin-bottom: 15px;"><div class="layui-card-body"><div class="layui-row"><div class="layui-col-md3" style="display: flex; justify-content: center;"><a href="courses?course_code='+ elem.code +'"><img class="shadow" src="'+ elem.cover +'"style="width:210px;"></a></div><div class="layui-col-md9"><div style="margin: 5px 1em;"><div style="font-family: Quicksand; font-weight: bold; text-align: left; font-size: 2em;"><a href="courses?course_code='+ elem.code +'">'+ elem.name +'</a></div><div class="layui-row"><div class="layui-col-md9"><p style="padding-top: 1%; text-align: left; font-family: Quicksand; font-weight: bold; font-size: 1.2em; margin-bottom: 0.2em; color:#8FBC8F;">ACTIVATE</p></div></div><div class="layui-row"><div class="layui-col-md9"><p style="padding-top: 7%; text-align: left; font-size: 1.2em; margin-bottom: 0.2em;">'+ elem.code +'</p><p style="text-align: left; font-size: 1.2em; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;">'+ semester_strings.join(', ') +'</p></div><div class="layui-col-md3" style="padding-top: 5%; text-align: center;"><a href="courses?course_code='+ elem.code +'" class="layui-btn layui-btn-lg layui-btn-violet" style="font-weight: normal;">查看课程</a></div></div></div></div></div></div></div>';
                                } else {
                                    cardHTML = '<div class="layui-card" style="border-radius: 10px; margin-bottom: 15px;"><div class="layui-card-body"><div class="layui-row"><div class="layui-col-md3" style="display: flex; justify-content: center;"><a href="courses?course_code='+ elem.code +'"><img class="shadow" src="'+ elem.cover +'"style="width:210px;"></a></div><div class="layui-col-md9"><div style="margin: 5px 1em;"><div style="font-family: Quicksand; font-weight: bold; text-align: left; font-size: 2em;"><a href="courses?course_code='+ elem.code +'">'+ elem.name +'</a></div><div class="layui-row"><div class="layui-col-md9"><p style="padding-top: 14%; text-align: left; font-size: 1.2em; margin-bottom: 0.2em;">'+ elem.code +'</p><p style="text-align: left; font-size: 1.2em; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;">'+ semester_strings.join(', ') +'</p></div><div class="layui-col-md3" style="padding-top: 12%; text-align: center;"><a href="courses?course_code='+ elem.code +'" class="layui-btn layui-btn-lg layui-btn-violet" style="font-weight: normal;">查看课程</a></div></div></div></div></div></div></div>';
                                }
