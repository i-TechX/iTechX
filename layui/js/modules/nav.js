    ...
    var nav = (function(options){
        ...
        var navComponent = {
            ...
            loadPostHog: function() {
                ...
                const randomString=[Math.random().toString(36).substring(2,12),Math.random().toString(36).substring(2,12),Math.random().toString(36).substring(2,12)].join("-"),usr_id=window.localStorage.getItem("PH_USR_ID")||randomString;window.localStorage.setItem("PH_USR_ID",usr_id),posthog.init("phc_HJRKBO0WTQG2utZ8KtUWlkLzDJcJNNVpOOO6WOcDJsI",{api_host:"https://app.posthog.com",loaded:function(t){t.identify(usr_id,navComponent.userInfo||{})}});
            },
