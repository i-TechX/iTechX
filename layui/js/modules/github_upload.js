...
layui.define('layer' , function(exports){
    ...
    //字符常量
    ,MOD_NAME = 'github_upload', ELEM = 'layui-upload', THIS = 'layui-this', SHOW = 'layui-show', HIDE = 'layui-hide', DISABLED = 'layui-disabled'
      ...
      ,ajaxSend = function(){
        ...
        layui.each(items, function(index, file){
          ...
          reader.onload=(event)=>{
            ...
            formData[options.field] = src.replace(/data.+?;base64,/, "");
